...
| Pod                         | Version                   |
| --------------------------- |:-------------------------:|
| `AffiseAttributionLib`      | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/a/9/3/AffiseAttributionLib) |
| `AffiseSKAdNetwork`         | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/3/6/f/AffiseSKAdNetwork)    |
| `AffiseModule/Advertising`  | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/)        |
| `AffiseModule/Link`         | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/)        |
| `AffiseModule/Status`       | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/)        |
| `AffiseModule/Subscription` | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/)        |
...
```ruby
# Affise SDK library
pod 'AffiseAttributionLib', '~> 1.6.44'
# Affise modules
pod 'AffiseModule/Advertising', '~> 1.6.44'
pod 'AffiseModule/Link', '~> 1.6.44'
pod 'AffiseModule/Status', '~> 1.6.44'
pod 'AffiseModule/Subscription', '~> 1.6.44'
```
...
```ruby
# Affise SDK library
pod 'AffiseAttributionLib', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
# Affise modules
pod 'AffiseModule/Advertising', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
pod 'AffiseModule/Link', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
pod 'AffiseModule/Status', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
pod 'AffiseModule/Subscription', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
```
...
| -------------- |:------------------------------------------------------------------------------------:|----------|
| `Advertising`  | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/) | `Manual` |
| `Link`         | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/) | `Auto`   |
| `Status`       | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/) | `Auto`   |
| `Subscription` | [`1.6.44`](https://github.com/CocoaPods/Specs/tree/master/Specs/0/3/d/AffiseModule/) | `Auto`   |
...
```ruby
# Wrapper for StoreKit Ad Network 
pod 'AffiseSKAdNetwork', :git => 'https://github.com/affise/sdk-ios.git', :tag => '1.6.44'
```
