#
#  Be sure to run `pod spec lint AfficeAttributionLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "AfficeAttributionLib", "AfficeAttributionLib/Attribution/**/*.{h,m,swift}"
